...
Motif PPG: 23
Red Goal: 24
 So whenever you get your shooting and intake mechanisms figured out, just add that code in the
...
public class motifTestAuto extends LinearOpMode {
    ...
    private void initAprilTag() {
        ...
        if (USE_WEBCAM) {
            visionPortal = new VisionPortal.Builder()
                    .setCamera((CameraName) hardwareMap.get(Limelight3A.class, "Limelight3A"))
